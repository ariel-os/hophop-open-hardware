...
3. **Fiducials & Alignment:** Include ~~at least~~ exactly 3 reference fiducials in an asymmetric pattern for PCB fabrication alignment. Add mounting holes (size TBD, likely M3 in 4-5 locations) for securing in enclosures or test rigs. Add 2-3 tooling holes on the panel. Diameter and placement to be coordinated with manufacturer.
